...
test.describe('Lixso Game - Complete Game Flow', () => {
  test('should complete full game flow from menu to playing', async ({ page }) => {
    ...
    if (await backButton.isVisible()) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/02-navigated-to-menu.png',
        fullPage: true,
      });
    }
    ...
    await page.screenshot({
      path: 'test-results/screenshots/04-player-name-entered.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/05-difficulty-selected.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/06-before-game-start.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/07-game-board-loaded.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-symbol-I-selected.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/09-orientation-selected.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/10-first-tile-placed.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/11-symbol-X-selected.png',
      fullPage: true,
    });
    ...
    await page.waitForTimeout(300);
    await page.screenshot({
      path: 'test-results/screenshots/12-after-rotation.png',
      fullPage: true,
    });
    ...
    for (let attempt = 0; attempt < 3; attempt++) {
      ...
      const symbols = ['S', 'O', 'I'];
      const symbolButton = page.locator(`.symbol-selector button:has-text("${symbols[attempt]}")`);
    ...
    await page.screenshot({
      path: 'test-results/screenshots/15-multiple-tiles-placed.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/17-difficulty-changed-to-level-2.png',
      fullPage: true,
    });
    ...
    await expect(playerNameInput).toHaveValue('TestMaster2024');
    await page.screenshot({
      path: 'test-results/screenshots/18-back-to-menu-final.png',
      fullPage: true,
    });
  });
  ...
  test('should handle game completion flow', async ({ page }) => {
    await page.goto('/');
    await page.screenshot({
      path: 'test-results/screenshots/completion-01-initial.png',
      fullPage: true,
    });
    ...
    if (await backButton.isVisible()) {
      ...
      await page.waitForTimeout(500);
      await page.screenshot({
        path: 'test-results/screenshots/completion-02-menu.png',
        fullPage: true,
      });
    }
    ...
    await level1Button.click();
    await page.screenshot({
      path: 'test-results/screenshots/completion-03-level-selected.png',
      fullPage: true,
    });
    ...
    await expect(page.locator('app-game-board')).toBeVisible();
    await page.screenshot({
      path: 'test-results/screenshots/completion-04-game-started.png',
      fullPage: true,
    });
    ...
    if (await completionMessage.isVisible()) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/completion-05-puzzle-completed.png',
        fullPage: true,
      });
    } else {
      await page.screenshot({
        path: 'test-results/screenshots/completion-05-puzzle-in-progress.png',
        fullPage: true,
      });
    }
    ...
    await page.screenshot({
      path: 'test-results/screenshots/completion-06-final-state.png',
      fullPage: true,
    });
  });
  ...
  test('should maintain state across difficulty changes', async ({ page }) => {
    await page.goto('/');
    await page.screenshot({
      path: 'test-results/screenshots/state-01-initial.png',
      fullPage: true,
    });
    ...
    await playerNameInput.blur();
    await page.screenshot({
      path: 'test-results/screenshots/state-03-name-entered.png',
      fullPage: true,
    });
    ...
    await level1.click();
    await page.screenshot({
      path: 'test-results/screenshots/state-04-level1-selected.png',
      fullPage: true,
    });
    ...
    await expect(page.locator('app-game-board')).toBeVisible();
    await page.screenshot({
      path: 'test-results/screenshots/state-05-game-started.png',
      fullPage: true,
    });
    ...
    await firstOrientation.click();
    await page.screenshot({
      path: 'test-results/screenshots/state-06-tile-controls-set.png',
      fullPage: true,
    });
    ...
    await page.waitForTimeout(500);
    await page.screenshot({
      path: 'test-results/screenshots/state-07-tile-placed.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/state-08-difficulty-changed.png',
      fullPage: true,
    });
    ...
    await cells.first().click({ force: true });
    await page.screenshot({
      path: 'test-results/screenshots/state-09-new-tile-placed.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/screenshots/state-10-back-to-menu.png',
      fullPage: true,
    });
  });
});
